    ...
    ***********************************-->
    <div id="main-wrapper" class="show menu-toggle">
        ...
        ***********************************-->
        ...
        <h1 class="job-heading">VIEW CLIENTS</h1>
          ...
          <div id="myDeleteModal" class="modal fade">
            <div class="modal-dialog modal-confirm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Do you really want to delete these client records? This process cannot be undone.</p>
                    </div>
                    <div class="modal-footer">
            ...
            if (data){
                ...
                data.forEach(item => {
                    ...
                    <tr>
                                                    ...
                                                    <td>${item.ageClient}</td>
                                                    <td>${item.complementAdresseClient}</td>
      ...
      $(document).on('click', '.deletejobdata', function() {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $.ajax({
                                ...
                                dataType: "json",
                                data:{
                                    "endpoint": "/authentication/delete",
                                    id:id,
                                    role_id:role_id,
                                },
                                success: function(data){
            ...
            $(document).on('click', '.updatejobdata', function() {
                    ...
                    $.ajax({
                        ...
                        type: 'POST',
                        dataType: "json",
                        data: {endpoint:"/clients/clientAPI-detail",id:upid},
                        success: function(data){
                            console.log(data);
                            $('input[name="prenomClient"]').val(data.prenomClient)
                            $('input[name="nomClient"]').val(data.nomClient)
                            $('input[name="telClient"]').val(data.telClient)
                            $('input[name="ageClient"]').val(data.ageClient)
            ...
            $('#updateformofClientdata').submit(function(e) {
                    ...
                    fd.append("endpoint","/clients/updateClient");
                    fd.append("id",uid);
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $.ajax({
                                ...
                                type: 'POST',
                                data: {
                                    endpoint:"/authentication/updateEmp/3/",
                                    id: uid,
                                    email: fd.get("emailClient"),
                                },
                                success: function(data){
                                    console.log("Success");
                                },
