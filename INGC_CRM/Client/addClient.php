                            ...
                            <div class="basic-form" >
                                <form id="addclientdata" method="post">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" placeholder="Enter Your Age" name="ageClient" id="ageClient">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="email" class="form-control" placeholder="E-mail" name="emailClient" id="emailClient">
                                        </div>
                                    </div>
                    ...
                    $('#addclientdata').submit(function(e) {
                        ...
                        messages:{
                            ...
                            telClient: {
                                ...
                                minlength: "Your phone number must atleast be 5 digits"
                            },
                            ageClient: {
                            ...
                            complementAdresseClient: {
                                ...
                                minlength: "Address must be atleast 3 characters"
                            },
                            emailClient: {
                        ...
                        submitHandler: function(form){
                            ...
                            fd.append("endpoint","/clients/addClient/")
